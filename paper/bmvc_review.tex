...
\rule{0pt}{1ex}\hspace{2.24mm}\includegraphics[width=2.33cm]{images/eg1_largeprint}\\[-0.1pt]}}}&
\bmvaHangBox{\fbox{\includegraphics[width=2.8cm]{images/eg1_largeprint}}}&
\bmvaHangBox{\fbox{\includegraphics[width=5.6cm]{images/eg1_2up}}}\\
(a)&(b)&(c)
\end{tabular}
